...
if __name__ == "__main__":
    ...
    input_dir = '/ubc/cs/research/cs/kmyi/fred/code/pdoct-reg/data/inputs/'
    output_dir = '/ubc/cs/research/cs/kmyi/fred/code/pdoct-reg/data/outputs/'
    ...
    moving_vol_files = [f for f in os.listdir(input_dir) if
                        f.endswith('_octv_mcorr.mat') and not f.startswith('fixed_')]
    ...
    image_files = [join(input_dir, "right_registered_enface.tif")]
    ...
    if mosaic:
        ...
        run_global_montage(
            ...
            moving_vol_fnames=matched_vols,
            moving_image_fnames=matched_images,
            moving_dopu_fnames=matched_dopus,
